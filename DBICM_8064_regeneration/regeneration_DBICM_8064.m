...
inter0 = randintrlv(int8(encData0),31); % Interleave.

% LDPC Encoding and interleaving
encData1 = ldpcEncoder(msg1);
inter1 = randintrlv(int8(encData1),31); % Interleave.

% LDPC Encoding and interleaving
encData2 = ldpcEncoder(msg2);
inter2 = randintrlv(int8(encData2),31); % Interleave.

% LDPC Encoding and interleaving
encData3 = ldpcEncoder(msg3);
inter3 = randintrlv(int8(encData3),31); % Interleave.
...
for n = 1:length(EbNoVec)
    ...
    while numErrs < 4000 && numBits < 1e7
        ...
        if iteration ~= 1
            ...
            % Deinterleaving
            undecoded_deintered = randdeintrlv(undecoded_flat,31); % Deinterleave.
            ...
            % Interleaving
            interllr = randintrlv(decodedllr,31); % Interleave.
